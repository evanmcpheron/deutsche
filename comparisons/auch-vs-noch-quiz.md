...
Nothing here tells you which word is being tested. Ask yourself whether something is **joining** or being **topped up**.

---

## Part A — Joining or Topping Up?

1. Anna orders a coffee. Ben, who hasn't ordered anything yet, wants one as well.\
   a. Ich möchte noch einen Kaffee.\
   b. Ich möchte wieder einen Kaffee.\
   c. Ich möchte nur einen Kaffee.\
...
**Explanation:** Ben is a new participant joining Anna's order. Option a would ask for a second coffee for Ben himself, which doesn't fit — he hasn't had a first.

</details>

2. Anna has finished her coffee and would like a second one.\
   a. Ich möchte auch einen Kaffee.\
   b. Ich möchte noch einen Kaffee.\
   c. Ich möchte wieder einen Kaffee.\
   d. Ich möchte schon einen Kaffee.
...
4. A café sells coffee. You discover they sell tea as well — a different item on the menu.\
   a. Wir haben auch Tee.\
   b. Wir brauchen noch Tee.\
   c. Wir haben noch Tee.\
   d. Wir haben wieder Tee.
...
**Explanation:** Tea joins coffee as a new kind of thing on offer. Option c would say the tea supply hasn't run out yet, which is a stock report rather than a menu.

</details>

5. Same café, end of the day. The tea is nearly gone and they need to order more.\
   a. Wir haben auch Tee.\
   b. Wir haben schon Tee.\
   c. Wir haben wieder Tee.\
   d. Wir brauchen noch Tee.
...
7. Four friends are going to the cinema, and Anna decides to come along.\
   a. Anna kommt auch.\
   b. Anna kommt noch.\
   c. Anna kommt wieder.\
   d. Anna kommt schon.
...
8. Five guests are already at the table, and one more person is still on the way.\
   a. Es kommt auch jemand.\
   b. Es kommt wieder jemand.\
   c. Es kommt schon jemand.\
   d. Es kommt noch jemand.
...
**Explanation:** Cake joins the list as something different. The other three are all about quantities of one item — more bread, more milk, remaining coffee.
...
**Explanation:** It isn't rude, just confusing — the server looks round for the other beer drinker. Wrong small words rarely offend; they leave people puzzled.
...
```text
A: Wir fahren im Sommer nach Italien.
B: Wir ___!
```
...
**Explanation:** B's family joins A's plan — a new participant. Option c would say B is returning to Italy, which is a claim about B's history, not about A.
...
**Explanation:** Two extra chairs on top of the existing ones. The other three all bring a new participant into something that was already true.
...
**Explanation:** A person, a product and a second time-haver, each joining something already true. Only b tops up the speaker's own order.
