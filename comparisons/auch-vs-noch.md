...
Both can feel like "also" in English, but they add different kinds of thing.

> **auch** — adds a **new participant**: someone or something joins what's already true.
> **noch** — adds **more of the same**: one extra unit of something already there.
...
Ask: **is something joining, or is something being topped up?**
...
1. Your friend orders a beer. You want one as well. What do you say?
   a. Ich möchte auch ein Bier.
   b. Ich möchte noch ein Bier.

2. You've finished your beer and want a second. What do you say?
   a. Ich möchte auch ein Bier.
   b. Ich möchte noch ein Bier.

3. Someone says *Ich bin müde*. How do you say "me too"?

4. Contrast: **Ich habe auch Zeit.** / **Ich habe noch Zeit.**

5. **Produce it:** Tell a server you'd like another glass of water.

<details>
<summary>Show answers</summary>

1. **a** — *auch*, because a different person is joining in.
2. **b** — *noch*, because it's one more of the same for you.
3. **Ich auch.**
4. *auch Zeit* = I have time as well as you do. *noch Zeit* = I still have time left.
5. A natural way to say this is **Noch ein Glas Wasser, bitte.**
