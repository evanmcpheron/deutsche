...
3. **Core comparison — `nicht` vs. `kein`:** [comparison](comparisons/nicht-vs-kein.md) → [quiz](comparisons/nicht-vs-kein-quiz.md)
4. **Core — `auch`:** [lesson](words/auch.md) → [quiz](words/auch-quiz.md)
5. **Core — `nur`:** [lesson](words/nur.md) → [quiz](words/nur-quiz.md)
6. **Core — `noch`:** [lesson](words/noch.md) → [quiz](words/noch-quiz.md)
7. **Core comparison — `auch` vs. `noch`:** [comparison](comparisons/auch-vs-noch.md) → [quiz](comparisons/auch-vs-noch-quiz.md)
...
1. **Core pattern — `noch nicht`:** [lesson](patterns/noch-nicht.md) → [quiz](patterns/noch-nicht-quiz.md)
2. **Core pattern — `nicht mehr`:** [lesson](patterns/nicht-mehr.md) → [quiz](patterns/nicht-mehr-quiz.md)
3. **Core comparison — `nicht mehr` vs. `noch`:** [comparison](comparisons/nicht-mehr-vs-noch.md) → [quiz](comparisons/nicht-mehr-vs-noch-quiz.md)
4. **Core — `immer`:** [lesson](words/immer.md) → [quiz](words/immer-quiz.md)
5. **Core pattern — `immer noch`:** [lesson](patterns/immer-noch.md) → [quiz](patterns/immer-noch-quiz.md)
6. **Core — `wieder`:** [lesson](words/wieder.md) → [quiz](words/wieder-quiz.md)
7. **Core comparison — `noch` vs. `wieder`:** [comparison](comparisons/noch-vs-wieder.md) → [quiz](comparisons/noch-vs-wieder-quiz.md)
...
3. **Recognition pattern — `gar nicht`:** [lesson](patterns/gar-nicht.md) → [quiz](patterns/gar-nicht-quiz.md)
4. **Core — `vielleicht`:** [lesson](words/vielleicht.md) → [quiz](words/vielleicht-quiz.md)
...
1. **Core — `mit`:** [lesson](prepositions/mit.md) → [quiz](prepositions/mit-quiz.md)
2. **Core — `bei`:** [lesson](prepositions/bei.md) → [quiz](prepositions/bei-quiz.md)
3. **Core comparison — `bei` vs. `mit`:** [comparison](comparisons/bei-vs-mit.md) → [quiz](comparisons/bei-vs-mit-quiz.md)
4. **Core — `zu`:** [lesson](prepositions/zu.md) → [quiz](prepositions/zu-quiz.md)
5. **Core — `nach`:** [lesson](prepositions/nach.md) → [quiz](prepositions/nach-quiz.md)
6. **Core comparison — `zu` vs. `nach`:** [comparison](comparisons/zu-vs-nach.md) → [quiz](comparisons/zu-vs-nach-quiz.md)
7. **Core comparison/chunk — `zu Hause` vs. `nach Hause`:** [comparison](comparisons/zu-hause-vs-nach-hause.md) → [quiz](comparisons/zu-hause-vs-nach-hause-quiz.md)
